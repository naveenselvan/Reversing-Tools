/*
 * memoryROM.x -- HighTec EasyRun-TC1796 flash memory configuration
 *
...
__EXT_CODE_RAM_BEGIN = 0x80020100;
__EXT_CODE_RAM_SIZE = 1920K;
...
MEMORY
{
  ext_cram (rx!p): org = 0x80020100, len = 1920K
